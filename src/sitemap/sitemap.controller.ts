...
import { NestPageService } from 'src/nest-page/nest-page.service';
...
export class SitemapController {
    ...
    constructor(
        private readonly nestPageService: NestPageService,
    ...
    async sitemap() {
        ...
        const pages = await this.nestPageService.findAll();
